...
import { InstantiateMsg, ExecuteMsg, Binary, Expiration, Timestamp, Uint64, Uint128, Action, Metadata, Trait, Empty, Coin, QueryMsg, Cw2981QueryMsg, AllNftInfoResponseForCw2981QueryMsg, OwnerOfResponse, Approval, NftInfoResponseForCw2981QueryMsg, OperatorsResponse, TokensResponse, ApprovalResponse, ApprovalsResponse, ContractInfoResponse, Null, NullableString, MinterResponse, NumTokensResponse, OperatorResponse, OwnershipForString } from "./Cw2981Royalties.types";
export interface Cw2981RoyaltiesReadOnlyInterface {
...
export class Cw2981RoyaltiesQueryClient implements Cw2981RoyaltiesReadOnlyInterface {
...
export interface Cw2981RoyaltiesInterface {
  contractAddress: string;
  sender: string;
  transferNft: ({
    recipient,
...
export class Cw2981RoyaltiesClient implements Cw2981RoyaltiesInterface {
