...
import { Addr, InstantiateMsg, RuleConfigMsg, ExecuteMsg, UpdateRuleConfigMsg, QueryMsg, QueryClaimableInfoResponse, QueryConfigResponse, QueryRuleInfoResponse, RuleConfig, RuleConfigState } from "./KptDistribute.types";
export interface KptDistributeReadOnlyInterface {
...
export class KptDistributeQueryClient implements KptDistributeReadOnlyInterface {
...
export interface KptDistributeInterface {
  contractAddress: string;
  sender: string;
  claim: ({
    ruleType
...
export class KptDistributeClient implements KptDistributeInterface {
