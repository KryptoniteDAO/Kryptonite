...
export class StakingOnlyQueryClient implements StakingOnlyReadOnlyInterface {
...
export interface StakingOnlyInterface {
  contractAddress: string;
  sender: string;
  receive: ({
    amount,
...
export class StakingOnlyClient implements StakingOnlyInterface {
