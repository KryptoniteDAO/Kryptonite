...
import { Addr, Uint128, InstantiateMsg, VeSeilorLockSetting, ExecuteMsg, QueryMsg, GetBoostConfigResponse, GetUnlockTimeResponse, GetUserBoostResponse, LockStatusResponse } from "./Boost.types";
export interface BoostReadOnlyInterface {
...
export class BoostQueryClient implements BoostReadOnlyInterface {
...
export class BoostClient implements BoostInterface {
