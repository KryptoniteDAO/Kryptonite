...
import { Uint128, Logo, EmbeddedLogo, Binary, Addr, InstantiateMsg, InstantiateMsg1, Cw20Coin, InstantiateMarketingInfo, MinterResponse, ExecuteMsg, Expiration, Timestamp, Uint64, QueryMsg, AllAccountsResponse, AllAllowancesResponse, AllowanceInfo, AllSpenderAllowancesResponse, SpenderAllowanceInfo, AllowanceResponse, BalanceResponse, DownloadLogoResponse, LogoInfo, MarketingInfoResponse, SeilorConfigResponse, TokenInfoResponse } from "./Seilor.types";
export interface SeilorReadOnlyInterface {
  contractAddress: string;
  seilorConfig: () => Promise<SeilorConfigResponse>;
  balance: ({
    address
  }: {
    address: string;
...
export class SeilorQueryClient implements SeilorReadOnlyInterface {
  ...
  constructor(client: CosmWasmClient, contractAddress: string) {
    ...
    this.seilorConfig = this.seilorConfig.bind(this);
  ...
  seilorConfig = async (): Promise<SeilorConfigResponse> => {
...
export interface SeilorInterface {
  contractAddress: string;
  sender: string;
  updateConfig: ({
