...
import { Uint256, BorrowerResponse, BorrowersResponse, ConfigResponse, BAssetInfo, Cw20HookMsg, ExecuteMsg, Uint128, Binary, Cw20ReceiveMsg, InstantiateMsg, MigrateMsg, QueryMsg } from "./CustodyBsei.types";
export interface CustodyBseiReadOnlyInterface {
...
export class CustodyBseiQueryClient implements CustodyBseiReadOnlyInterface {
